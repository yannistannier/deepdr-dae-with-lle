...
bottlenek = Dense(10, activity_regularizer=regularizers.l1(10e-5), activation='relu', name="bottleneck")(encoded)
...
model.load_weights("result_fashion/deepr_sparcity.h5")
...
sub_train_noise = [x_train_noisy[x:x+100] for x in range(0, len(x_train_noisy), 100)]

for epoch in range(0,200):
    for idd, x in enumerate(sub_train[:-1]):
...
model.save("result_fashion/deepr_sparcity.h5")
